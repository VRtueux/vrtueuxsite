    ...
    <section id="about" className="py-20 bg-slate-900 relative">
      ...
      {popupOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="relative w-full max-w-sm sm:max-w-md lg:max-w-lg rounded-2xl overflow-hidden bg-gradient-to-tr from-cyan-800/80 to-purple-900/80 p-4 sm:p-6 shadow-2xl">
            <button
