// Exemple si ton logo est un SVG React Component
import { Gamepad2, Move, Car } from 'lucide-react';
import NexusLogo from './NexusLogo'; // <-- ton logo ici
...
export function About() {
  const features = [
    ...
    {
      icon: NexusLogo, // <-- remplacement ici
      title: 'Mode Arcade',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 bg-gradient-to-r from-purple-900/30 to-cyan-900/30 rounded-2xl p-8 border border-purple-500/20">
          <div className="flex items-center justify-center gap-3 mb-4">
            <NexusLogo className="text-cyan-400" size={32} /> {/* ici aussi */}
